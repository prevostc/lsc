            ...
            case 0x21d2da23 {
                if iszero(lt(calldatasize(), 0x44)) {
                    if lt(0, calldataload(0x04)) {
                        if lt(0, sload(0)) {
                            if lt(0, sload(0x01)) {
                                if iszero(lt(add(sload(0x01), calldataload(0x04)), sload(0x01))) {
                                    mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                    mstore(0x84, 0x11)
                                    if add(sload(0x01), calldataload(0x04)) {
                                        if or(iszero(calldataload(0x04)), eq(div(mul(calldataload(0x04), sload(0)), calldataload(0x04)), sload(0))) {
                                            mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                            mstore(0x84, 0x11)
                                            if iszero(lt(div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04))), calldataload(0x24))) { revert(0x80, 0x04); } else {
                                                mstore(0x80, 0xbb2875c300000000000000000000000000000000000000000000000000000000)
                                                if lt(0, div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04)))) {
                                                    if iszero(lt(add(sload(0x01), calldataload(0x04)), sload(0x01))) {
                                                        mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                        mstore(0x84, 0x11)
                                                        sstore(0x01, add(sload(0x01), calldataload(0x04)))
                                                        if iszero(lt(sload(0), div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04))))) {
                                                            mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                            mstore(0x84, 0x11)
                                                            sstore(0, sub(sload(0), div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04)))))
                                                            ...
                                                            if call(0x0f4240, sload(0x05), 0, 0x80, 0x64, 0x80, 0x20) { revert(0, 0); } else {
                                                                if or(iszero(returndatasize()), and(iszero(lt(returndatasize(), 0x20)), eq(mload(0x80), 0x01))) {
                                                                    if iszero(eq(0x01, 0)) { revert(0x80, 0x04); } else {
                                                                        ...
                                                                        mstore(0x84, caller())
                                                                        mstore(0xa4, div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04))))
                                                                        ...
                                                                        if call(0x0f4240, sload(0x04), 0, 0x80, 0x44, 0x80, 0x20) { revert(0, 0); } else {
                                                                            if or(iszero(returndatasize()), and(iszero(lt(returndatasize(), 0x20)), eq(mload(0x80), 0x01))) {
                                                                                if iszero(eq(0x01, 0)) { revert(0, 0); } else {
                                                                                    ...
                                                                                    mstore(0xc0, div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04))))
                                                                                    log1(0x80, 0x60, 0xec43a82fae8c251f7aae4f79accf59c765bd798d597ccfd95beef20bf096cc9e)
                                                                                    mstore(0x80, div(mul(calldataload(0x04), sload(0)), add(sload(0x01), calldataload(0x04))))
                                                                                    return(0x80, 0x20)
                        ...
                        if lt(0, sload(0)) {
                            if lt(0, sload(0x01)) {
                                if iszero(lt(add(sload(0), calldataload(0x04)), sload(0))) {
                                    mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                    mstore(0x84, 0x11)
                                    if add(sload(0), calldataload(0x04)) {
                                        if or(iszero(calldataload(0x04)), eq(div(mul(calldataload(0x04), sload(0x01)), calldataload(0x04)), sload(0x01))) {
                                            mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                            mstore(0x84, 0x11)
                                            if iszero(lt(div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04))), calldataload(0x24))) { revert(0x80, 0x04); } else {
                                                mstore(0x80, 0xbb2875c300000000000000000000000000000000000000000000000000000000)
                                                if lt(0, div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04)))) {
                                                    if iszero(lt(add(sload(0), calldataload(0x04)), sload(0))) {
                                                        mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                        mstore(0x84, 0x11)
                                                        sstore(0, add(sload(0), calldataload(0x04)))
                                                        if iszero(lt(sload(0x01), div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04))))) {
                                                            mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                            mstore(0x84, 0x11)
                                                            sstore(0x01, sub(sload(0x01), div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04)))))
                                                            mstore(0x80, 0x23b872dd00000000000000000000000000000000000000000000000000000000)
                                                            mstore(0x84, caller())
                                                            mstore(0xa4, address())
                                                            mstore(0xc4, calldataload(0x04))
                                                            ...
                                                            if call(0x0f4240, sload(0x04), 0, 0x80, 0x64, 0x80, 0x20) { revert(0, 0); } else {
                                                                if or(iszero(returndatasize()), and(iszero(lt(returndatasize(), 0x20)), eq(mload(0x80), 0x01))) {
                                                                    if iszero(eq(0x01, 0)) { revert(0x80, 0x04); } else {
                                                                        ...
                                                                        mstore(0x80, 0xa9059cbb00000000000000000000000000000000000000000000000000000000)
                                                                        mstore(0x84, caller())
                                                                        mstore(0xa4, div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04))))
                                                                        ...
                                                                        if call(0x0f4240, sload(0x05), 0, 0x80, 0x44, 0x80, 0x20) { revert(0, 0); } else {
                                                                            if or(iszero(returndatasize()), and(iszero(lt(returndatasize(), 0x20)), eq(mload(0x80), 0x01))) {
                                                                                if iszero(eq(0x01, 0)) { revert(0, 0); } else {
                                                                                    ...
                                                                                    mstore(0x80, caller())
                                                                                    mstore(0xa0, calldataload(0x04))
                                                                                    mstore(0xc0, div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04))))
                                                                                    log1(0x80, 0x60, 0x268d208c45ec3d7213f545c4402b1bc7f11b332757a4e0d84ff4d37b90db1fca)
                                                                                    mstore(0x80, div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04))))
                                                                                    return(0x80, 0x20)
                                                                                    mstore(0x80, 0x1078b53300000000000000000000000000000000000000000000000000000000)
                                                                                    mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                                                    mstore(0x84, 0x12)
                    ...
                    if lt(0, calldataload(0x04)) {
                        if lt(0, sload(0)) {
                            if iszero(lt(add(sload(0), calldataload(0x04)), sload(0))) {
                                ...
                                mstore(0x84, 0x11)
                                if add(sload(0), calldataload(0x04)) {
                                    if or(iszero(calldataload(0x04)), eq(div(mul(calldataload(0x04), sload(0x01)), calldataload(0x04)), sload(0x01))) { revert(0, 0); } else {
                                        mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                        mstore(0x84, 0x11)
                                        mstore(0x80, div(mul(calldataload(0x04), sload(0x01)), add(sload(0), calldataload(0x04))))
                                        return(0x80, 0x20)
