...
theorem mstoreArgs_exec {env : List Nat} {V tail : VEnv evm}
  ...
  | cons a rest =>
    ...
    | nil =>
      ...
      have hmA := eval_mstore_atom_fwd (env := env) funs st tokv 0 a hV htail hn hn1 hi0
      let stA : EvmState :=
    ...
    | cons a2 rest2 =>
      ...
      | nil =>
        ...
        have hdoA : ExecStmt evm funs V st
            ...
            V stA .normal := by
          simpa [Nat.mul_zero, Nat.add_zero] using Step.exprStmt hmA
        have hmB := eval_mstore_atom_fwd (env := env) funs stA tokv 1 a2 hV htail hn hn1 hi1
        let stB : EvmState :=
      ...
      | cons a3 rest3 =>
        ...
        | nil =>
          ...
          have hdoB : ExecStmt evm funs V stA
              ...
              V stB .normal :=
            Step.exprStmt hmB
          have hmC := eval_mstore_atom_fwd (env := env) funs stB tokv 2 a3 hV htail hn hn1 hi2
          let stC : EvmState :=
