    ...
    object "runtime" {
        code {
            ...
            */
                                                                                                                ...
                                                                                                                if call(0x0f4240, sload(0x01), 0, 0x80, 0x44, 0x80, 0x20) { revert(0, 0); } else {
                                                                                                                    if or(iszero(returndatasize()), and(iszero(lt(returndatasize(), 0x20)), lt(returndatasize(), 0x40))) {
                                                                                                                        if eq(or(iszero(returndatasize()), iszero(iszero(mload(0x80)))), 0x01) { revert(0x80, 0x04); } else {
                                                                                                                            ...
                                                                                                                            mstore(0x80, caller())
                                                                                                                            mstore(0xa0, 0x01)
                                                                                                                            mstore(0xc0, mload(0x0100))
                                                                                                                            mstore(0xe0, div(mul(sload(0x03), div(mul(mload(0x0100), 0x26f2), 0x2710)), add(sload(0x02), div(mul(mload(0x0100), 0x26f2), 0x2710))))
                                                                                                                            log1(0x80, 0x80, 0xbfd50a04f1e6e4aee344f5d0e7f15d74d0dbb58cd1f711daa6463094ca9508cd)
                                                                                                                            tstore(0, 0)
            ...
            /*
            * @custom:signature    Unresolved_a1af5b9a() public returns (bytes memory)
            */
            case 0xa1af5b9a {
