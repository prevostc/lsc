                                                                                                                                                    ...
                                                                                                                                                    if lt(0, mload(0x0100)) {
                                                                                                                                                        if iszero(lt(add(sload(0x02), mload(0x0100)), sload(0x02))) {
                                                                                                                                                            ...
                                                                                                                                                            if iszero(lt(add(sload(0x03), mload(0x0120)), sload(0x03))) {
                                                                                                                                                                ...
                                                                                                                                                                mstore(0x84, 0x11)
                                                                                                                                                                sstore(0x03, add(sload(0x03), mload(0x0120)))
                                                                                                                                                                if iszero(lt(add(mload(0x0100), sload(0x04)), mload(0x0100))) {
                                                                                                                                                                    mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                                                                                                                                    mstore(0x84, 0x11)
                                                                                                                                                                    sstore(0x04, add(mload(0x0100), sload(0x04)))
                                                                                                                                                                    mstore(0, caller())
                                                                                                                                                                    mstore(0x20, 0x05)
                                                                            ...
                                                                            if 0x2710 {
                                                                                ...
                                                                                if or(iszero(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710))), eq(div(mul(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710)), sload(0x08)), sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710))), sload(0x08))) {
                                                                                    ...
                                                                                    if iszero(lt(mload(0x0100), div(mul(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710)), sload(0x08)), 0x2710))) {
                                                                                        mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                                                        mstore(0x84, 0x11)
                                                                                        if iszero(lt(add(sload(0x03), sub(mload(0x0100), div(mul(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710)), sload(0x08)), 0x2710))), sload(0x03))) {
                                                                                            mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                                                            mstore(0x84, 0x11)
                                                                                            sstore(0x03, add(sload(0x03), sub(mload(0x0100), div(mul(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710)), sload(0x08)), 0x2710))))
                                                                                            if iszero(lt(sload(0x02), mload(0x0120))) {
                                                                                                mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                                                                mstore(0x84, 0x11)
                                                                                                sstore(0x02, sub(sload(0x02), mload(0x0120)))
                                                                                                if iszero(lt(add(sload(0x0a), div(mul(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710)), sload(0x08)), 0x2710)), sload(0x0a))) {
                                                                                                    mstore(0x80, 0x4e487b7100000000000000000000000000000000000000000000000000000000)
                                                                                                    mstore(0x84, 0x11)
                                                                                                    sstore(0x0a, add(sload(0x0a), div(mul(sub(mload(0x0100), div(mul(mload(0x0100), 0x26f2), 0x2710)), sload(0x08)), 0x2710)))
                                                                                                    mstore(0x80, 0x23b872dd00000000000000000000000000000000000000000000000000000000)
                                                                                                    mstore(0x84, caller())
                                                                                                    mstore(0xa4, address())
                                                                                                    mstore(0xc4, mload(0x0100))
