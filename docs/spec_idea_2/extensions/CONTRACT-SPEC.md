...
Optional extension to the main [DESIGN.md](../DESIGN.md). Not required for v1. Addresses the gap identified by comparison with evm-smith's spec/proof separation approach.
...
- **§12**: If adopted, consider a spec legibility guideline — not a v1 requirement
