...
theorem core_sim_ext_callFree {S E ε}
  ...
  intro w env V st funs hfuns hwf hn hinv hAgr _hOr _hNR e' hem V' st' out hexec
...
theorem core_sim_ext {S E ε}
  ...
  | opTail op =>
    intro hS2 w env V st funs hfuns hwf hn hinv hAgr hOr hNR e' hem V' st' out hexec
